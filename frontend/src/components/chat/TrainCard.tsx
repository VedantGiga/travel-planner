...
const TrainCard = ({ operator, departure, arrival, duration, price, trainNumber }: TrainCardProps) => {
  return (
    <motion.div
      whileHover={{ scale: 1.02 }}
      className="rounded-xl p-4 bg-muted/50 border border-border/50 backdrop-blur-sm hover:border-secondary/50 transition-all"
    >
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex-1 flex flex-col items-center px-4">
          <Train className="h-4 w-4 text-secondary mb-1" />
